<?php
  ...
  $GLOBALS['TL_LANG']['tl_content']['news_archive'] = array('News Archive', 'Please select the Newsarchive.');
  $GLOBALS['TL_LANG']['tl_content']['news'] = array('News', 'Select a news.');
  $GLOBALS['TL_LANG']['tl_content']['news_template'] = array('News Template', 'Select a news template.');
